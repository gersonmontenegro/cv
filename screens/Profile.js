        ...
        <View style={{marginTop: 0, marginLeft: 5, marginRight: 5}}>
          <ScrollView>
            ...
            <Text style={{fontFamily: 'CenturyGothic', textAlign: 'left'}}>
              ...
              {"\n"}
              {"\n"}
              Besides that, I've been worked for about 10 years in Startup companies, so, I know how they think about technology and what the developers do they need in order to create any kind of application, actually, I usually define myself like an "everything will be all right" person, and I like to find and to solve errors not only in my apps, but in another people apps.
              {"\n"}
              {"\n"}
              I like to much learn to code and learn better ways to do my apps, but it doesn't mean that I'm only a coder, because in the last years I've had the oportunity to lead developer teams in many projects, such as C4 Systems, like mobile aplications (iOS, Android), and wep applications as well.
              {"\n"}
              {"\n"}
